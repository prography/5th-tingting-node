...
router.post('/thumbnail-img', verifyToken, upload.single('thumbnail'), updateMyThumbnailImg) // 내 썸네일 사진 수정
router.post('/profile-img', verifyToken, upload.single('profileImg'), saveMyProfileImg)// 내 프로필 이미지 저장
router.post('/profile-img/:imgId', verifyToken, upload.single('profileImg'), updateMyProfileImg)// 내 프로필 이미지 수정
